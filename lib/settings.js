...
export const SHIP_CLASSES = {
  interceptor: {
    ...
    fuelUse: 5.4,
    combat: 1.4,
    blurb: "A fighter that can mine. Still heavy enough to slide. The cutter is a sidearm, the hold is a glovebox, and nothing in the belt outruns you.",
  },
  gunship: {
    id: "gunship",
    name: "Gunship",
    ...
    fuelUse: 4.5,
    combat: 1.15,
    blurb: "Patrol hull. Decent cutter, decent guns, a hold that is not embarrassed. Mass you can feel when you cut the mains.",
  },
  hauler: {
    id: "hauler",
    name: "Hauler",
    ...
    fuelUse: 3.4,
    combat: 0.72,
    blurb: "Ore mule. Best mining laser and the biggest hold. Turns like a rumor, slides like a barge, fights like a filing cabinet.",
  },
  yacht: {
    id: "yacht",
    name: "Yacht",
    ...
    fuelUse: 3.8,
    combat: 0.9,
    blurb: "Saucer runabout. Heavier than it looks. Nimble enough, a mediocre miner. Bring friends or bring patience.",
  },
};
